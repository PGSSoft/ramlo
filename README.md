...
## Note
:boom: It is currently during development and uses [RAML 1.0 JS Parser (beta)](https://github.com/raml-org/raml-js-parser-2), so can be highly unstable.
...
For generating documentation please use API described in file `manageably-1.0.raml` or `manageably-0.8.raml`.
...
```
:boom: Unfortunately Osprey Mock Service does not support RAML 1.0.
